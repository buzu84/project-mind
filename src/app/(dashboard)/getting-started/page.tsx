...
const workflowSteps = [
  {
    ...
    fields: [
      { name: "Project Name", why: "Identifies your product across all tools and outputs." },
      {
        ...
        why: "Grounds competitive analysis and positioning in the right market.",
      },
      {
        name: "Description",
        why: "Gives AI a baseline understanding of what the product does. At least 1–2 sentences.",
      },
      {
        name: "Target Users",
        why: "Shapes user stories, persona analysis, and feature prioritization.",
      },
      {
        name: "Business Model",
        why: "Informs revenue-related recommendations and competitive positioning.",
      },
      {
        name: "Goals",
        why: "Used as alignment criteria for roadmap prioritization and PRD success metrics.",
      },
    ],
  },
  {
...
const tools = [
  {
    ...
    outputs:
      "Executive summary, problem statement, user stories, success metrics, functional requirements, technical considerations.",
  ...
  },
  {
    ...
    bestInputs:
      "A list of 3+ feature ideas with brief descriptions. Project goals for alignment context.",
    outputs:
      "Scored feature table with RICE/ICE rankings, AI commentary per feature, sortable by priority.",
  ...
  },
  {
    ...
    outputs:
      "Prioritized timeline, risk assessment, dependency mapping, success metrics per phase.",
  ...
  },
  {
    ...
    bestFor:
      "Understanding where your product fits in the market and identifying differentiation opportunities.",
  },
  {
    name: "AI Insights",
    does: "Generates strategic risks, opportunities, recommended next actions, and roadmap suggestions.",
    bestInputs:
      "Rich project context and uploaded evidence. Works best after other tools have run.",
    outputs:
      "Categorized insight cards: key risks, opportunities, next actions, and roadmap suggestions.",
  ...
  },
  {
    ...
    bestInputs:
      "A clearly stated decision or question. Relevant feedback documents uploaded to the project.",
    outputs:
      "Options with pros/cons, assumptions, retrieved evidence, risks, and a confidence-scored recommendation.",
    bestFor:
      "Making high-stakes product decisions with evidence-based reasoning instead of gut feeling.",
  },
  {
    ...
    outputs:
      "Four independent perspective evaluations plus a consensus highlighting agreements, disagreements, and blind spots.",
  ...
  },
  {
    ...
    bestInputs:
      "Specific questions about your product, feedback, or strategy. Works best with uploaded documents.",
  ...
  },
  {
    ...
    bestFor:
      "Generic questions that aren't tied to a specific project. For project-grounded answers, use the per-project AI Chat instead.",
  },
];

const bestPractices = [
  {
    do: "Provide specific, measurable product goals",
    why: '"Increase retention by 15%" produces better outputs than "grow the product."',
  },
  {
    do: "Upload real user feedback",
    why: "Even a few interview quotes dramatically improve decision review and PRD quality.",
  },
  {
    do: "Include constraints and tradeoffs",
    why: "Prevents the AI from recommending things you can't build.",
  },
  {
    do: "Add competitor context",
    why: "Improves competitive analysis and positioning recommendations.",
  },
  {
    do: "Keep project context updated",
    why: "As your product evolves, update goals and constraints so outputs stay relevant.",
  },
  {
    do: "Review all AI outputs before acting on them",
    why: "AI outputs are starting points — not final decisions. Human judgment is always required.",
  },
];

const commonMistakes = [
  {
    mistake: "Creating a project with no description or goals",
    impact: "AI outputs will be generic and unhelpful.",
  },
  {
    mistake: "Uploading irrelevant or off-topic documents",
    impact: "RAG retrieval may inject unrelated context into outputs.",
  },
  {
    mistake: 'Writing vague feature requests like "make it better"',
    impact: "RICE/ICE scoring can't evaluate features without clear scope.",
  },
  {
    mistake: "Treating AI outputs as final decisions",
    impact: "All generated content requires human review, domain expertise, and validation.",
  },
  {
    mistake: "Running Decision Review without any uploaded evidence",
    impact: "The review will work but won't be grounded in your actual user data.",
  },
];
...
export default function GettingStartedPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-12">
      {/* Hero */}
      <section>
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Getting Started</h1>
        <p className="mt-2 text-base text-gray-600">
          ProductMind works best when AI has rich project context. Better context produces better
          PRDs, roadmaps, decisions, and analysis.
        </p>
          ...
          {workflowSteps.map((s) => (
            <div key={s.step} className="rounded-xl border border-gray-200 bg-white p-6">
              <div className="flex items-baseline gap-3">
                <span className="text-sm font-bold text-brand-600">Step {s.step}</span>
              ...
              {s.fields && (
                <div className="mt-4 space-y-2">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    {s.fields.map((f) => (
                      <div key={f.name} className="rounded-lg bg-gray-50 px-3 py-2">
            ...
            <div key={t.name} className="rounded-xl border border-gray-200 bg-white p-5">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-3">
                <div className="rounded-lg bg-blue-50 px-3 py-2">
                  <p className="text-[11px] font-semibold uppercase text-blue-600">Best inputs</p>
                ...
                <div className="rounded-lg bg-emerald-50 px-3 py-2">
                  ...
                  <p className="mt-0.5 text-xs text-emerald-900">{t.outputs}</p>
                </div>
                <div className="rounded-lg bg-purple-50 px-3 py-2">
                  <p className="text-[11px] font-semibold uppercase text-purple-600">Best for</p>
      ...
      <section>
        <h2 className="text-xl font-bold text-gray-900">How to get the best results</h2>
        <p className="mb-4 mt-1 text-sm text-gray-500">
          Practical guidance for higher-quality AI outputs.
        </p>
        <div className="grid gap-3 sm:grid-cols-2">
          {bestPractices.map((bp) => (
            <div key={bp.do} className="rounded-lg border border-gray-200 bg-white px-4 py-3">
      ...
      <section>
        <h2 className="text-xl font-bold text-gray-900">Example: high-quality project context</h2>
        <p className="mb-4 mt-1 text-sm text-gray-500">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 text-sm leading-relaxed text-gray-700">
          <div className="space-y-3">
            ...
            <div>
              ...
              <p>
                Increase average order value by 12% through personalized menu suggestions within 6
                months of launch.
              </p>
            </div>
            <div>
              ...
              <p>
                Diners spend 40% of their visit time choosing from large menus. 25% report decision
                fatigue that reduces satisfaction and upsell potential.
              </p>
            </div>
            <div>
              <p className="font-semibold text-gray-900">Constraints</p>
              <p>
                Must support allergen filtering (EU regulation). Initial launch limited to 50
                partner restaurants. No native app — web-only via QR code.
              </p>
            </div>
            <div>
              <p className="font-semibold text-gray-900">Success metrics</p>
              <p>
                Average order value, time-to-order, diner satisfaction score, restaurant churn rate.
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <p className="mb-4 mt-1 text-sm text-gray-500">Patterns that reduce AI output quality.</p>
        <div className="space-y-2">
          {commonMistakes.map((m) => (
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-red-900">{m.mistake}</p>
